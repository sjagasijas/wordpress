...
<html>
 ...
 <head>
	...
	<title> Explain & Simply for only $950 </title>
...
.watch-more {
	...
	<div class="promo-content-right">
		...
		<div class="promo-cf-desktop-wrapper">
		  ...
		  <div class="cf-title">High-tier Explainer Video for only <strong>$950</strong> per minute</div>
...
<!--	<div class="promo-timer">
	...
	<div class="footer-bottom">		
	  ...
	  <div class="text-center">  
		<a title="ModeoMedia" href="<?php bloginfo('url'); ?>" target="_blank" style="color:#fff;">  ModeoMedia </a> 	&copy; 2012-2019 All Rights Reserved <br> </div>		
