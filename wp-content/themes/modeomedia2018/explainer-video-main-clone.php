<?php
/*
Template Name: Explainer Video Main clone Page
*/
...
border-color: transparent transparent transparent #f4f8f9;
right: -25px;
margin-top: 35px;
position: absolute;
}
...
.swiper-pagination-bullet{font-weight: bold;}
...
.video-section-2, .video-section-3, .video-section-4, .video-section-5 {
    height: 100%;
	padding-bottom: 80%;
}
...
.video-section-2-title,.video-section-3-title,.video-section-4-title,.video-section-5-title {
    font-size: 32px;
	line-height: 45px;
}	
...
<div class="max-width" >
                ...
                <div class="video-section-2-title">
                    ...
                    Benefit of Using an Explainer Video!
...
<section class="video-section-5"><!---------------------------------------------video-section-5----------------------------------->
...
<div class="max-width" >
                ...
                <div class="video-section-5-content">
                 ...
                 <div class="video-section-5-button"> <a href="<?php bloginfo('url');?>/get-in-touch" target="_blank"> <p> I'm Interested. </p>  </a> </div> 
...
var menu = ['Healthcare', 'E-Commerce', 'Products', 'Science and Technology', 'Business Solution', 'Software & Saas']
